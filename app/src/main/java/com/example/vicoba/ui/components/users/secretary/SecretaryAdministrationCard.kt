package com.example.vicoba.ui.components.users.secretary
...
@Composable
fun SecretaryAdministrationCard(
    ...
    Column(
        ...
        if (expanded) {
            ManagementCard(
                ...
                text = "Ratibu maombi ya mikopo.",
                onClickManagementCard = {
                    navHostController.navigate(AppRoutes.ManageLoans.name)
                }
            )
        }
    }
